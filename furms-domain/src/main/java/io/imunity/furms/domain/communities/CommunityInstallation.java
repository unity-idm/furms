...
public class CommunityInstallation
{
	public final CommunityId id;
	public final String name;
	public final String description;

	public CommunityInstallation(CommunityId id, String name, String description)
	{
		this.id = id;
		this.name = name;
	...
	public boolean equals(Object o)
	{
		...
		CommunityInstallation that = (CommunityInstallation) o;
