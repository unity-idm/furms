...
public enum Role {
	FENIX_ADMIN(
		...
		List.of(
			...
			FENIX_ADMINS_MANAGEMENT, READ_ALL_USERS, FENIX_MAINTENANCE
		),
		List.of(
	...
	SITE_ADMIN(
		...
		"ADMIN",
		List.of(
			AUTHENTICATED, PROFILE, SITE_READ, SITE_WRITE, SITE_ADMINS_MANAGEMENT, READ_ALL_USERS
		),
		emptyList()
	),
	COMMUNITY_ADMIN(
		...
		List.of(
			...
			COMMUNITY_ADMINS_MANAGEMENT, READ_ALL_USERS
		),
		emptyList()
	),
	PROJECT_ADMIN(
		...
		List.of(
			...
			PROJECT_MEMBER_MANAGEMENT, READ_ALL_USERS
		),
		emptyList()
	),
	PROJECT_MEMBER(
