...
public class AlarmCreatedEvent implements ProjectApplicationEvent {
	public final FenixUserId id;
	public final String projectId;
	public final Set<FURMSUser> projectAdmins;

	public AlarmCreatedEvent(FenixUserId id, String projectId, Set<FURMSUser> projectAdmins) {
		this.id = id;
	...
	public boolean equals(Object o) {
		...
		AlarmCreatedEvent userEvent = (AlarmCreatedEvent) o;
