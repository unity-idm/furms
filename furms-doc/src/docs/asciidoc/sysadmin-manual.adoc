...
./20210211-214739/furms-server-1.0.0/logs
...
./20210211-214739/unity-server-3.4.3/logs
...
The ``workspace/`` directory can be ignored, it contains temporary installation data. The ``current`` symlink points to the currently active revision. It is especially relevant when there are more than one installation.

Inside the ``current/`` directory there are both services installed. Logs and other runtime data like PIDs can be found there.
