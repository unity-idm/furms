...
public class ResourceUsageEntity extends UUIDIdentifiable {
	...
	ResourceUsageEntity(UUID projectId, UUID projectAllocationId, BigDecimal cumulativeConsumption, LocalDateTime probedAt) {
	...
	public static final class ResourceUsageEntityBuilder {
		...
		public ResourceUsageEntity build() {
			return new ResourceUsageEntity(projectId, projectAllocationId, cumulativeConsumption, probedAt);
		}
	}
}
