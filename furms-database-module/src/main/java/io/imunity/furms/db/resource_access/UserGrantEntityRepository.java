...
public interface UserGrantEntityRepository extends CrudRepository<UserGrantEntity, UUID> {
	@Query(
		...
		"uaj.id as job_id, uaj.correlation_id as job_correlation_id, uaj.user_allocation_id as job_user_allocation_id, uaj.status as job_status, uaj.message as job_message " +
