...
public class UserResourceUsageEntity extends UUIDIdentifiable {
	...
	UserResourceUsageEntity(UUID projectId, UUID projectAllocationId, String fenixUserId, BigDecimal cumulativeConsumption, LocalDateTime consumedUntil) {
	...
	public static final class UserResourceUsageEntityBuilder {
		...
		public UserResourceUsageEntity build() {
			return new UserResourceUsageEntity(projectId, projectAllocationId, fenixUserId, cumulativeConsumption, consumedUntil);
		}
	}
}
