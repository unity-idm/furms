...
class ProjectInstallationMessageResolverImpl implements ProjectInstallationMessageResolver {
	...
	ProjectInstallationMessageResolverImpl(ProjectOperationRepository projectOperationRepository, SiteRepository siteRepository) {
	...
	public boolean isMessageCorrelated(CorrelationId id, SiteExternalId siteExternalId) {
		...
		SiteExternalId externalId = siteRepository.findByIdExternalId(installationJobByCorrelationId.siteId);
