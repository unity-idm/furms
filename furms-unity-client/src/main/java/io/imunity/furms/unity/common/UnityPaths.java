...
public class UnityPaths {
	...
	public final static String GROUP_MEMBERS = "/group-members-attributes/";
	public final static String GROUP_MEMBERS_MULTI = "/multi-group-members-attributes/";
	...
	public final static String DIRECT_GROUP_ATTRIBUTES = "entity/{"+ ID +"}/groups/direct/attributes";
