...
public class ResourceCreditAllocationsGridItem {
	...
	ResourceCreditAllocationsGridItem(ResourceCreditId id,
	                                  SiteId siteId,
	                                  String siteName,
	                                  String name,
	...
	public boolean equals(Object o) {
		...
		ResourceCreditAllocationsGridItem that = (ResourceCreditAllocationsGridItem) o;
	...
	public static final class DashboardGridItemBuilder {
		...
		public DashboardGridItemBuilder id(ResourceCreditId id) {
			this.id = id;
			return this;
		}
		...
		public ResourceCreditAllocationsGridItem build() {
			return new ResourceCreditAllocationsGridItem(id, siteId, siteName, name, communityId, split, resourceType, credit,
