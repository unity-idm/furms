...
public class UserSettingsMenu extends FurmsAppLayout {
	...
	UserSettingsMenu(FurmsLayoutFactory furmsLayoutFactory,
	                 VaadinBroadcaster vaadinBroadcaster,
	                 AuthzService authzService,
	                 RoleTranslator roleTranslator,
	                 FurmsLayoutExtraPanelsConfig extraPanelsConfig) {
		super(roleTranslator, vaadinBroadcaster, authzService, ViewMode.USER, furmsLayoutFactory, extraPanelsConfig,
				Stream.of(
