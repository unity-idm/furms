...
class CommunityAllocationComboBoxesModelsResolver {
	...
	CommunityAllocationComboBoxesModelsResolver(Set<Site> sites, Function<String, Set<ResourceType>> functionResourceType, Function<String, Set<ResourceCredit>> functionResourceCredit) {
