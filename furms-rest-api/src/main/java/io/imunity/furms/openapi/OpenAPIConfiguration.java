...
class OpenAPIConfiguration
{
	...
	OpenAPI customOpenAPI(@Value("${app.version:unknown}") String version) 
	{
		...
		return new OpenAPI()
				...
				.addSecurityItem(new SecurityRequirement().addList(APIDocConstants.FURMS_SECURITY_SCHEME))
				.components(new Components()
						.addSecuritySchemes(APIDocConstants.CIDP_SECURITY_SCHEME, cidpSecScheme)
						.addSecuritySchemes(APIDocConstants.FURMS_SECURITY_SCHEME, apiKeyScheme));
	}
}
