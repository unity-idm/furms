...
@Tag(
		...
		description = "FURMS administration endpoint that provides comprehensive access to Projects "
...
public class ProjectsRestController
{
	...
	@Operation(
			...
			description = "Create particular allocation for given project.",
			security = {@SecurityRequirement(name = APIDocConstants.FURMS_SECURITY_SCHEME)}
	)
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successful operation"),
	...
	public List<ProjectAllocation> getCreateAllocation(@PathVariable("projectId") String projectId,
