...
public class CommunitiesRestController
{
	...
	//@formatter:off
	@Operation(
			summary     = "Retrieve particular community information",
	...
	//@formatter:off
	@Operation(
			summary     = "Retrieve particular allocation information",
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successful operation"),
			@ApiResponse(responseCode = "403", description = "Permission denied"),
			@ApiResponse(responseCode = "404", description = "Community or allocation not found", content = {@Content})
	})
	//@formatter:on
